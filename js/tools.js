...
function enableTool(tool) {
    if (tool === "drawing") {
        ...
        console.log("Setting tool image to 'image/scraper.png'");
    } 
    else if (tool === "smudge") {
        isSmudgeToolEnabled = true;
        currentImage.src = 'image/too3.png';
        currentImage.style.scale = 0.9;
        console.log("Setting tool image to 'image/too3.png'");
    } 
    else if (tool === "bubble") {
        isBubbleToolEnabled = true;
        currentImage.src = 'image/sponge.png';
        console.log("Setting tool image to 'image/sponge.png'");
    } 
    else if (tool === "brush") {
        isBrushToolEnabled = true;
        currentImage.src = 'image/brush.png';
        console.log("Setting tool image to 'image/brush.png'");
    } 
    else if (tool === "mop") {
        isMopBrushEnabled = true;
        currentImage.src = 'image/mop.png';
        console.log("Setting tool image to 'image/mop.png'");
    } 
    else if (tool === "slice") {
        isSliceStrokeEnabled = true;
        currentImage.src = 'image/slice.png';
        console.log("Setting tool image to 'image/slice.png'");
    } 
    else if (tool === "spray") { 
        isSprayToolEnabled = true;
        currentImage.src = 'image/sprayer2.png';
        console.log("Setting tool image to 'image/sprayer2.png'");
    }
...
const updateCursor = (angle, src, enlarge, offsetx, offsety, brushsize) => {
    ...
    cursorImage.crossOrigin = "anonymous"; // Cross-origin 설정 추가
    cursorImage.src = src;
    cursorImage.onload = () => {
